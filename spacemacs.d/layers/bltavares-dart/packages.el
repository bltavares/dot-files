...
(defconst bltavares-dart-packages
  '(dart-mode
    flycheck))

;; TODO: Remove when https://github.com/bradyt/dart-mode/pull/67
(defun bltavares-dart/trigger-hooks ()
...
(defun bltavares-dart/init-dart-mode ()
  (use-package dart-mode
    ...
    (progn
      ...
      (add-hook 'dart-mode-hook #'bltavares-dart/trigger-hooks))
...
This can be customized by setting `dart-formatter-command-override'."
  ...
  (defun bltavares-dart/post-init-flycheck ()
